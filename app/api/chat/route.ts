  ...
  try {
    ...
    if (!process.env.DATABASE_URL) {
      ...
      if (message.includes("severe illness") || message.includes("omp")) {
        responseMessage = "Based on our consolidated insurance products data, OMP Severe Illness Cover provides lump sum payments for 68 severe illnesses. Coverage starts from N$40/month with comprehensive family protection benefits. Would you like me to provide detailed information about eligibility or claim procedures?";
        ...
        sources = ["DEATH_CLAIMS_CONSOLIDATED.md", "INSURANCE_PRODUCTS_CONSOLIDATED.md"];
        toolsUsed = ["claims_procedure_lookup"];
      } else if (message.includes("unit trust") || message.includes("investment")) {
        responseMessage = "Our investment retirement guide shows Old Mutual Unit Trusts offer professional management with minimum investments from N$100/month. The Income Fund provides 7.2% annual returns with high income focus. Would you like information about specific funds or retirement planning?";
        ...
        responseMessage = "According to our disability claims consolidated information, OMP Disability Income Cover provides 75% income replacement after a 6-month waiting period. Claims are processed within 15 working days of receiving complete documentation. I can guide you through the claim requirements.";
