-- Migration: Fix hybrid_search function return type mismatch
-- Issue: ts_rank_cd returns REAL but function declares FLOAT (DOUBLE PRECISION)
-- Solution: Cast ts_rank_cd result to DOUBLE PRECISION
